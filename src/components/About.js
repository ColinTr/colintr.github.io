            ...
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div
                    ...
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
                        ...
                        <br className="hidden lg:inline-block"/>This website is a work in progress.
                    </h1>
                ...
                <div className="lg:max-w-lg lg:w-half md:w-1/2 w-5/6">
                    <img className="object-cover object-center rounded" alt="hero" src={'/assets/profil_carre_no_background_circle_cropped.png'} />
                </div>
            </div>
        </section>
    );
